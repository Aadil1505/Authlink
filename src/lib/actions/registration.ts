...
import { NfcTagRegistrationResponse, BlockchainRegistrationResponse, ProductInfo, ProductRegistrationResponse, CompleteRegistrationResponse } from "@/types/registration";
