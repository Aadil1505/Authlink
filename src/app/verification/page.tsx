...
//   // Get the new parameter format
//   const picc_data = searchParams.picc_data as string
//   const enc = searchParams.enc as string
//   const cmac = searchParams.cmac as string

//   console.log("Parameters received:", { picc_data, enc, cmac });
  
//   let verificationResult: SuccessResponse | null = null;
//   let error: string | null = null;
  
//   // Check if all required parameters are provided
//   const hasAllParams = picc_data && enc && cmac;
  
//   // Only attempt verification if all parameters are present
//   if (hasAllParams) {
//     const verification = await verifyTag(picc_data, enc, cmac);
...
//     }
//   } else {
//     error = "Missing required parameters (picc_data, enc, or cmac)";
//   }
...
//   // If we have a verified result, use the UID from that
//   const navigationUid = verificationResult?.uid || '';
...
//                   {isVerified ? (
//                     <Button variant="outline">
//                       <Link href={`verification/${navigationUid}`} className='flex items-center justify-center'>                    
//                         <Check className="mr-2 h-3.5 w-3.5" />
//                         Continue
//                       </Link>
//                     </Button>
